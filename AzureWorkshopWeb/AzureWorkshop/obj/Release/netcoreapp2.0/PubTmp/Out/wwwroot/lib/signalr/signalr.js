...
var HttpConnection = /** @class */ (function () {
    function HttpConnection(url, transferFormat, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.transport.connect(this.url, this.transferFormat, this)];
                    case 4:
                        _a.sent();
        ...
        if (!transport) {
            ...
            if (!requestedTransport || transport === requestedTransport) {
                if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
                    this.logger.log(ILogger.LogLevel.Trace, "Selecting transport '" + transport + "'");
                    return transport;
                }
                else {
                    this.logger.log(ILogger.LogLevel.Trace, "Skipping transport '" + transport + "' because it does not support the requested transfer format '" + requestedTransferFormat + "'.");
                }
            }
            else {
                this.logger.log(ILogger.LogLevel.Trace, "Skipping transport '" + transport + "' because it was disabled by the client.");
            }
        }
        return null;
    };
...
var HubConnection = /** @class */ (function () {
    function HubConnection(urlOrConnection, options) {
        ...
        if (typeof urlOrConnection === "string") {
            this.connection = new HttpConnection_1.HttpConnection(urlOrConnection, this.protocol.transferFormat, options);
        }
        else {
    ...
    HubConnection.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection.start()];
                    case 1:
                        _a.sent();
