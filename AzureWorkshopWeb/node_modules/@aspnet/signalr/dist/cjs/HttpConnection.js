        ...
        if (!transport) {
            ...
            if (!requestedTransport || transport === requestedTransport) {
                if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
                    this.logger.log(ILogger_1.LogLevel.Trace, "Selecting transport '" + transport + "'");
                    return transport;
                }
                else {
                    this.logger.log(ILogger_1.LogLevel.Trace, "Skipping transport '" + transport + "' because it does not support the requested transfer format '" + requestedTransferFormat + "'.");
                }
            }
            else {
                this.logger.log(ILogger_1.LogLevel.Trace, "Skipping transport '" + transport + "' because it was disabled by the client.");
            }
        }
        return null;
    };
